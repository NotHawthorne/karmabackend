...
var buildResources = exports.buildResources = function () {
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee(self) {
    ...
    var parsedIconsResult, _retrieveIcons, _retrieveIcons2, _results, config, _parsedIconsResult, _parsedIconsResult$ic, icons, _parsedIconsResult$as, assets, results;
    ...
    return (_regenerator || _load_regenerator()).default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _parsedIconsResult = parsedIconsResult, _parsedIconsResult$ic = _parsedIconsResult.icons, icons = _parsedIconsResult$ic === undefined ? {} : _parsedIconsResult$ic, _parsedIconsResult$as = _parsedIconsResult.assets, assets = _parsedIconsResult$as === undefined ? [] : _parsedIconsResult$as;
            results = writeManifestToFile(self.manifest, self.options, publicPath, icons);
...
function writeManifestToFile(manifest, options, publicPath, icons) {
  var content = (0, (_extends2 || _load_extends()).default)({}, manifest, { icons: icons });
...
function generateAppleTags(manifest, assets) {
  var tags = {};
  if (manifest.ios) {
    var apple = {
    ...
    if ((0, (_typeof2 || _load_typeof()).default)(manifest.ios) === 'object') {
      apple = (0, (_extends2 || _load_extends()).default)({}, apple, manifest.ios);
    }
